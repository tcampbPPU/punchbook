...
<template>
  <div>
    ...
    >
      <client-only>
        <TransitionTopToBottom>
          <div v-if="filtering" class="absolute bottom-0 -mb-11 left-4">
            <div
              class="relative z-50 border border-gray-300 rounded shadow dark:bg-gray-800"
            >
              <div
              ...
              <div class="flex items-center p-2">
                ...
                >
                  <Icon
                    class="w-3 h-3 text-gray-300 hover:text-gray-500"
                    icon="ci:filter"
                  />
                </button>
              </div>
      ...
      >
        <span>
          {{ props.column.label ? props.column.label : props.column.field }}
        </span>
        <Icon
          class="w-4 h-4 text-gray-300 hover:text-gray-500"
          icon="bx:sort-alt-2"
        />
      </div>
      <div
