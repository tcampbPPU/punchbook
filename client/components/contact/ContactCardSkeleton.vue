    ...
    <div class="flex items-center justify-between w-full p-6 space-x-6">
      <div class="flex-1 truncate">
        <div class="flex items-center space-x-3">
          <h3
            class="w-32 text-sm font-medium leading-5 text-gray-900 truncate skeleton"
          >
            &nbsp;
          </h3>
        </div>
        <p class="mt-1 text-sm leading-5 text-gray-500 truncate skeleton w-36">
          &nbsp;
        </p>
      </div>
      <div
        class="flex-shrink-0 w-10 h-10 overflow-hidden rounded-full skeleton"
      ></div>
    </div>
    <div class="border-t border-gray-200 dark:border-gray-500">
      <div class="flex -mt-px">
        <div
          class="flex flex-1 w-0 border-r border-gray-200 dark:border-gray-500"
        >
          <a
            ...
            href="#"
          >
            <div class="w-20 h-full skeleton">&nbsp;</div>
          </a>
        </div>
